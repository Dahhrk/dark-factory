# Gap matrix — public pstack vs this kitchen

Audit date: **7 Sep 2026**. Labels per [evidence-standard.md](evidence-standard.md). Interactive board: kitchen research canvas.
...
|------------|------------|-------------|------|-----|-----|
| Router / rigor pack | pstack `/poteto-mode` | unpublished personal mode | pstack + models + factory rule (**VERIFIED**) | None | — |
| Personal mode | `/automate-me` | unpublished personal mode | `/brooklyn-mode` exists (**VERIFIED**) | Not eval'd — fine for now | P2 |
...
| Feature Map | four-H2 contract | ~12 Glass files (**SELF-REPORTED**) | 4 files home + mark-ready + copy-contract + reload-reset (**VERIFIED**) | Shape yes | — |
...
| Decision ledger | `/show-me-your-work` | decisions TSV | `audit/decisions.tsv` 14+ rows (**VERIFIED**) | Still skipped on busy days | P1 |
...
| Outer loop → queue | Grok routines / Make Bot UI | Slack/X farmers feed aim | grokbot-fleet + 8 bots + 11 gitignored YAML drafts (**VERIFIED** on disk). Triggers not live on this machine. | Zero bot-written inbox rows. `sync_routines` unproven. | P0 |
| Benny | pstack pack | live `#issues-glass` | staged off fail-closed (**VERIFIED**) | Correctly gated on Slack | P2 |
| Overnight | autonomous-run playbook | ~20 auto-merges/night (**SELF-REPORTED**) | Flashpeek night ran 4 Sep. Control-Glass overnight **absent** | TRUST-NEXT still the gate. Flashpeek does not count | P0 |
...
| Spend / PR volume | do not copy lab spend | lab tokens + 1k–2k PRs/mo (**SELF-REPORTED**) | spend cap **SELF-REPORTED** | Never chase published volume or spend | Never |
...
- [match-ceiling.md](match-ceiling.md) · [system-map.md](system-map.md) · [SELF-IMPROVE.md](SELF-IMPROVE.md) · [TRUST-NEXT.md](TRUST-NEXT.md) · [SETUP-STATUS.md](SETUP-STATUS.md)
