...
5. Dune contract on that repo: conventional path is cheaper than a shortcut; forbidden imports fail CI; one writer per durable value; new work is isolated files; exceptions are architecture PRs. See [dune-method.md](dune-method.md). Optional: [adjacent-taste.md](adjacent-taste.md) · [adjacent-growth.md](adjacent-growth.md).
